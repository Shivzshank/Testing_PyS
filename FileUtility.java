...
public class FileUtility {
	...
	public String ReadDataFromTestingDataFile(String key) throws IOException {
		FileInputStream fileInputStream = new FileInputStream("./src/source/resources/TestingData.txt");
		Properties properties = new Properties();
		properties.load(fileInputStream);
		String value = properties.getProperty(key);
		return value;
